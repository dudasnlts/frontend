...
const routes = [
  ...
  { path: "/admin/joias",       name: "admin-joias",       component: AdminJoias,     meta: { requiresAdmin: true, showNav: false } },
  { path: "/admin/perfumes",    name: "admin-perfumes",    component: AdminPerfumes,  meta: { requiresAdmin: true, showNav: false } },
  { path: "/admin/pingentes",   name: "admin-pingentes",   component: AdminPingentes, meta: { requiresAdmin: true, showNav: false } },
  { path: "/admin/relogios",    name: "admin-relogios",    component: AdminRelogios,  meta: { requiresAdmin: true, showNav: false } },
  { path: "/admin/sales",       name: "admin-sales",       component: AdminSales,     meta: { requiresAdmin: true, showNav: false } },
